...
int main() {
    ...
    std::cout << "=== JTextSplitEventLog High-Throughput Test (optimized) ===\n";
    std::cout << "Events: " << NUM_EVENTS << " | " << INT_COUNT << " ints + " << DBL_COUNT << " doubles\n\n";

    JTextSplitEventLog log("JText_Throughput_Test", INT_COUNT, DBL_COUNT);
    ...
    for (size_t i = 0; i < NUM_EVENTS; ++i) {
        ...
        log.append_event(i, i % 250, i % 4000, flags,
                         "THROUGHPUT", "jtext test payload", i * 777,
                         ints, dbls);
    }
    ...
    std::cout << "Files: " << log.main_file() << " (and _Ints, _Floats)\n";
