...
static void run_one(const std::string& name, size_t payload_size, size_t num_events) {
    ...
    BinaryEventLog log("Binary_Payload_" + std::to_string(payload_size), INT_COUNT, DBL_COUNT,
                       PersistMode::All, 32 * 1024 * 1024);  // 32MB buffer for speed
