...
using LogConfigxMainx = ts_store_config<100, 16, 32, true>;  // BufferSize=96, TypeSize=12, CategorySize=24, UseTimestamps=true
using LogxStore = ts_store<LogConfigxMainx>;

using LogConfigResult = ts_store_config<128, 16, 32, true>;  // BufferSize=96, TypeSize=12, CategorySize=24, UseTimestamps=true
