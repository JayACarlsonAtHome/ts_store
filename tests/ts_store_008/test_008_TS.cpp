...
void print_test_purpose(size_t total, size_t keeper_n, size_t db_n) {
    ...
    std::cout << " Plan: " << total << " in-memory events\n";
...
int main(int argc, char** argv) {
    ...
    std::cout << "  jText main rows (KeeperRecord):  " << file_rows << " (expected " << keeper_n << ")\n";
    std::cout << "  SQLite main rows (DatabaseEntry): " << sql_rows  << " (expected " << db_n << ")\n";
    ...
    std::cout << "═══════════════════════════════════════════════════════════════\n";
    std::cout << "  Events in memory   : " << format_locale_int(static_cast<std::uint64_t>(total)) << "\n";
    std::cout << "  Persisted (file)   : " << format_locale_int(static_cast<std::uint64_t>(file_rows)) << "\n";
    std::cout << "  Persisted (SQL)    : " << format_locale_int(static_cast<std::uint64_t>(sql_rows)) << "\n";
